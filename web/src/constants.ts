...
const FEWSHOT_EXAMPLE = `# 🧪 Exemple de réponse attendue
...
Pendant la période d'essai, l'employeur peut rompre le contrat de travail sans avoir à justifier d'un motif, sous réserve de respecter un délai de prévenance — *Fiche service-public "La période d'essai du CDI" — https://www.service-public.fr/particuliers/vosdroits/F1643*. Ce délai varie selon le temps de présence du salarié dans l'entreprise — *Article L1221-25 du Code du travail — https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000019071098*.
...
**Références**
- *Fiche service-public "La période d'essai du CDI"* — https://www.service-public.fr/particuliers/vosdroits/F1643
- *Article L1221-25 du Code du travail* — https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000029144958
...
Toute heure de travail accomplie à la demande de l'employeur au-delà de la durée légale hebdomadaire de 35 heures constitue une heure supplémentaire — *Fiche service-public "Heures supplémentaires d'un salarié du secteur privé" — https://www.service-public.gouv.fr/particuliers/vosdroits/F2391*. Ces heures ouvrent droit soit à une majoration de salaire, soit à un repos compensateur de remplacement équivalent — *Page Ministère du travail "Les heures supplémentaires : contreparties" — https://travail-emploi.gouv.fr/les-heures-supplementaires-contreparties*.

En l'absence d'accord ou de convention collective, les taux de majoration sont fixés à 25 % pour les huit premières heures supplémentaires hebdomadaires (de la 36e à la 43e) et 50 % au-delà — *Fiche service-public "Heures supplémentaires d'un salarié du secteur privé" — https://www.service-public.gouv.fr/particuliers/vosdroits/F2391*.
...
**Références**
- *Fiche service-public "Heures supplémentaires d'un salarié du secteur privé"* — https://www.service-public.gouv.fr/particuliers/vosdroits/F2391
- *Page Ministère du travail "Les heures supplémentaires : contreparties"* — https://travail-emploi.gouv.fr/les-heures-supplementaires-contreparties

## Exemple 3 — Absence de source pertinente (refus)
...
Le Code du travail ne fixe pas de durée légale de préavis en cas de démission d'un salarié en CDI. La durée applicable est déterminée par la convention collective, le contrat de travail, ou les usages — *Fiche service-public "La démission" — https://www.service-public.fr/particuliers/vosdroits/F112*.
...
Votre préavis de démission est donc de 3 mois, sauf accord avec votre employeur pour le réduire. Pour plus de détails sur les dispositions de votre convention collective, consultez : https://code.travail.gouv.fr/convention-collective/1486

**Références**
- *Fiche service-public "La démission"* — https://www.service-public.fr/particuliers/vosdroits/F112
- *Convention collective Bureaux d'études techniques, cabinets d'ingénieurs-conseils et sociétés de conseils, "Quelle est la durée du préavis en cas de démission ?"* — https://code.travail.gouv.fr/contribution/1486

---

## Exemple 2 — CAS 2 : la base ne contient aucune disposition spécifique pour cette convention

**Contexte** : l'utilisateur est soumis à une convention collective **{IDCC_NAME}** (IDCC {IDCC_NUMBER}) pour laquelle la base de connaissance ne contient pas d'extrait pertinent à la question posée.
...
Tout salarié a droit à un congé non rémunéré en cas de maladie ou d'accident, constaté par certificat médical, d'un enfant de moins de 16 ans dont il assume la charge — *Article L1225-61 du Code du travail — https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000033458100*. La durée de ce congé est de 3 jours par an, portée à 5 jours si l'enfant a moins d'un an ou si le salarié assume la charge de trois enfants ou plus de moins de 16 ans — *Fiche service-public "Congé pour enfant malade" — https://www.service-public.fr/particuliers/vosdroits/F3127*.

### 2. Dispositions spécifiques à la convention {IDCC_NUMBER} "{IDCC_NAME}"

Je ne dispose pas d'information spécifique sur votre convention collective **{IDCC_NAME}** (IDCC {IDCC_NUMBER}) dans la base de connaissance fournie. Votre convention peut prévoir des dispositions plus favorables (jours supplémentaires, rémunération du congé), mais je ne peux pas vous les préciser.

### 3. Conclusion

Au titre du Code du travail, vous bénéficiez de 3 ou 5 jours selon votre situation familiale. Pour vérifier les dispositions plus favorables éventuellement prévues par votre convention collective, consultez : [URL_convention_collective]

**Références**
- *Article L1225-61 du Code du travail* — https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006900948
- *Fiche service-public "Congé pour enfant malade"* — https://www.service-public.fr/particuliers/vosdroits/F3127`;
